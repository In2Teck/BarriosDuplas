...
function onReady(){
  if (getParameterByName("solo_mujeres")) {
    ...
    var html = "<div id='solo_mujeres_container'><p class='lead_text'>ESTE DESAFÍO ES SÓLO PARA MUJERES. <br/> PERO AÚN PUEDES PONERTE A PRUEBA <br/> CON LOS RETOS DE NIKE+.</p></div>"; 
  ...
  $(window).resize(function() {
      setTimeout(function() {
          ...
          if (width <= 900) {
            ...
            solo_mujeres = { width: "242px", height: "250px", background: "url('/assets/bg_popup_home.jpg')", "padding-top": "55%", "text-align": "center",  "background-size": "242px 250px" };
            ...
            solo_mujeres = { width: "472px", height: "488px", background: "url('/assets/bg_popup_home.jpg')", "padding-top": "65%", "text-align": "center", "background-size": "472px 488px"};
