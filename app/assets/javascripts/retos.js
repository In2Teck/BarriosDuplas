...
function muestraRewardsBadge(){
  ...
  var html = "<div id='sub_izq' class='retos_izq responsive_bck'><p class='sub_head_music' >RETO:<br/>\"CORRAN EN CONJUNTO COMO MÍNIMO 120KM EN LOS<br/>PRÓXIMOS 6 DÍAS, LAS 200 DUPLAS QUE REGISTREN MÁS<br/>KILÓMETROS EN ESTOS DÍAS SERÁN ACREEDORAS<br/>DE UN ARTÍCULO CONMEMORATIVO DE LA CAMPAÑA<br/>JUNTAS CORREMOS\".<br/><br/>DURACIÓN:<br/>MARTES 20 DE MAYO A LAS 00:01 AL DOMINGO<br/>25 DE MAYO A LAS 11:59PM. (6 DÍAS).<br/>SE ENVIARÁ UN MAIL A LAS GANADORAS DE ESTE RETO PARA<br/>QUE VAYAN A RECOGER SU PULSERA.</p><div class='pulsera'><img src='/assets/rewards_pulsera_icon.png' /></div></div><div id='sub_der' class='retos_der responsive_bck centered overflow_hidden'><img src='" +  img + "' class='modal_reto' /></div>"; 
  modalDialogue(html);
}
