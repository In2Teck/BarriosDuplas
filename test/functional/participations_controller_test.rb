...
class ParticipationsControllerTest < ActionController::TestCase
  ...
  test "should create participation" do
    assert_difference('Participation.count') do
      post :create, participation: { accomplished: @participation.accomplished, challenge_id: @participation.challenge_id, register_number: @participation.register_number, user_id: @participation.user_id }
    end
  ...
  test "should update participation" do
    put :update, id: @participation, participation: { accomplished: @participation.accomplished, challenge_id: @participation.challenge_id, register_number: @participation.register_number, user_id: @participation.user_id }
    assert_redirected_to participation_path(assigns(:participation))
  end
