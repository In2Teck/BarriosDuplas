...
Challenge.create({:name=> "Fast Track", :description=>"Superen los entrenamientos anteriores.", :start_date => DateTime.new(2014, 2, 11, 6, 0, 1)})
Challenge.create({:name=>"Wake Up", :description=>"Despertar temprano es avanzar primero. Elijan un dia y corran las dos antes de las 7 AM.", :start_date => DateTime.new(2014, 2, 11, 6, 0, 1)})
Challenge.create({:name=>"10K", :description=>"Un compromiso entre amigas puede sumar 10 KM en un dia. ¡Demuestrenlo!", :start_date => DateTime.new(2014, 2, 11, 6, 0, 1)})
